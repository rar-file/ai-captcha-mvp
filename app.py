...
<head>
  ...
  <style>body{background:#070910;color:#e9edf7;font-family:system-ui;display:flex;justify-content:center;padding:30px} .wrap{max-width:760px;width:100%} code,pre{background:#0f121a;border:1px solid #232a3a;padding:10px;border-radius:12px;display:block;overflow:auto}</style>
</head>
<body>
  <div class='wrap'>
    <h2>AI Captcha Demo</h2>
    <p>This page shows the drop-in widget.</p>
